package com.foxtail.core.mybatis;
 ...
 */  
public class SqlSessionFactoryBeanExt implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {  
  ...
  private String environment = SqlSessionFactoryBeanExt.class.getSimpleName();  
